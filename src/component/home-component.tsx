      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        ...
        >
          ...
          <span className="text-sm font-medium">
            click here for amazing content
          </span>
          <svg
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-nonemd:text-5xl lg:text-6xl dark:text-white text-blue-500">
          Welcome to Binary Corner
        </h1>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
          Here we focus on technology, innovation, and capital can unlock
